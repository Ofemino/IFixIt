...
public class SelectedServiceOptionsPageService
{
    ...
    public Task<Models_ServiceProvider?> GetSelectedServiceOptionById(int id)
    {
        return Task.FromResult(ServiceProvidersList.FirstOrDefault(i => i.id == id));
    }

    public Task<List<ServiceProviderFeedbacks>> GetServiceProviderFeedbacks(int id)
    {
        return Task.FromResult(ServiceProviderFeedbackList);
    }
